...
export default class WebGLView {
	...
	initRenderTri() {
		...
		this.RenderTriTarget = new THREE.WebGLRenderTarget(resolution.x, resolution.y, {
	...
	initParticlesRenderTarget() {
		this.particlesRt = new THREE.WebGLRenderTarget(window.innerWidth, window.innerHeight);
		this.particlesRtCamera = new THREE.PerspectiveCamera(50, window.innerWidth / window.innerHeight, 0.01, 100);
